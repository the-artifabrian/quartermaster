...
> invite codes — either earned by hitting engagement milestones as an existing
> Pro user, or generated by admins for launches. Admin subscription management
> page shipped at `/admin/subscriptions` (manual tier changes + invite code
> generation). Stripe integration not yet built.
