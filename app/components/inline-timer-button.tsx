...
export function InlineTimerButton({
	...
	return (
		<button
			...
			onClick={handleClick}
			disabled={atMax}
			className="bg-primary/10 text-primary hover:bg-primary/15 mx-0.5 inline-flex min-h-[44px] min-w-[44px] items-center justify-center gap-1 rounded-full border border-transparent px-2.5 py-1 text-xs font-medium transition-colors disabled:opacity-40"
		>
