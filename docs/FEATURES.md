...
- PWA with service worker for offline access, iOS standalone meta tags,
  and `apple-touch-startup-image` splash screens for all device sizes
  (light + dark, generated by `other/generate-splash-screens.mjs`)
