...
export function InlineTimerButton({
	...
	return (
		<button
			...
			onClick={handleClick}
			disabled={atMax}
			className="bg-accent/10 text-accent hover:bg-accent/20 disabled:opacity-40 mx-0.5 inline-flex items-center gap-1 rounded-full border border-transparent px-2 py-0.5 text-xs font-medium transition-colors"
		>
			<Icon name="timer" className="size-3" />
