...
INSERT INTO "new_InventoryItem" ("createdAt", "householdId", "id", "location", "name", "updatedAt", "userId") SELECT "createdAt", "householdId", "id", "location", "name", "updatedAt", "userId" FROM "InventoryItem";
