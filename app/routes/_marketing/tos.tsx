...
export default function TermsOfServiceRoute() {
	return (
		<div className="container max-w-2xl py-12">
			<h1 className="font-serif text-[2.25rem] leading-[1.15] tracking-[-0.02em]">Terms of Service</h1>
			...
			<div className="mt-8 space-y-6 text-sm/6">
				<section>
					<h2 className="font-serif text-[1.5rem] leading-[1.3] tracking-[-0.01em]">Using Quartermaster</h2>
				...
				<section>
					<h2 className="font-serif text-[1.5rem] leading-[1.3] tracking-[-0.01em]">Your content</h2>
					<p className="text-muted-foreground mt-2">
				...
				<section>
					<h2 className="font-serif text-[1.5rem] leading-[1.3] tracking-[-0.01em]">Account responsibility</h2>
					<p className="text-muted-foreground mt-2">
				...
				<section>
					<h2 className="font-serif text-[1.5rem] leading-[1.3] tracking-[-0.01em]">Acceptable use</h2>
					<p className="text-muted-foreground mt-2">
				...
				<section>
					<h2 className="font-serif text-[1.5rem] leading-[1.3] tracking-[-0.01em]">Service availability</h2>
					<p className="text-muted-foreground mt-2">
