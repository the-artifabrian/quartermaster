...
export function TimerWidget() {
	...
	if (!isExpanded) {
		return (
			<button
				...
				className={cn(
					'fixed right-4 bottom-[9rem] z-50 flex items-center gap-2 rounded-full px-4 shadow-lg transition-all hover:scale-105 md:right-6 md:bottom-6 print:hidden',
					hasAlarming
	...
	return (
		<div className="fixed right-4 bottom-[9rem] z-50 md:right-6 md:bottom-6 print:hidden">
