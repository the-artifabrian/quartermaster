...
INSERT INTO "new_InventoryItem" ("id", "name", "location", "lowStock", "createdAt", "updatedAt", "userId", "householdId") SELECT "id", "name", "location", "lowStock", "createdAt", "updatedAt", "userId", "householdId" FROM "InventoryItem";
